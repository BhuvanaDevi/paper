...
<body>
  ...
  <tr>
    ...
    <td><?= $row[$i][5] ?></td>
    <td><?= $row[$i][6] ?></td>
    <td><a href="accept.php?paper=<?= $row[$i][5] ?>&email=<?= $row[$i][3] ?>" class="btn btn-success">Accept</a>&nbsp;<a href="stock.php?paper=<?= $row[$i][5] ?>&email=<?= $row[$i][3] ?>" class="btn btn-danger">No Stock</a></td>
  </tr>
<?php } ?>
