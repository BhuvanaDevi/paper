              ...
              <div class="col-lg-6 align-self-center">
                <form id="contact" action="" method="POST">
                  <div class="row">
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="name" name="username" id="username" placeholder="Name" autocomplete="on" required>
                      </fieldset>
                    </div>
                    <div class="col-lg-6">
                      <fieldset>
                    ...
                    <option value="Please Select Paper Type">Please Select Paper Type</option>
                        <?php for($i=0;$i<$nol;$i++){?>
                    ...
                    <div class="col-lg-12">
                      <fieldset>
                        <button type="submit" name="contact" id="form-submit" class="main-button "><i class="fa fa-paper-plane"></i> Send Message</button>
                      </fieldset>
                    </div>
                  </div>
                </form>
...
if(isset($_POST['contact'])){
  ...
  $ins="insert into contact(username,mobile,email,paper,message) values('$name','$mobile','$email','$paper','$message')";
